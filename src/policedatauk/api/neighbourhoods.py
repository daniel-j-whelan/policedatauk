...
class AsyncNeighbourhoodAPI(BaseAsyncAPI):
    """Neighbourhood-related asyncronous API methods for the UK Police API."""
    ...
    async def get_all_neighbourhoods(
        ...
        """
        response = await self.get("/neighbourhoods")
    ...
    async def get_neighbourhood(
        ...
        """
        response = await self.get(f"/{force}/{neighbourhood_id}")
    ...
    async def get_boundary(
        ...
        """
        response = await self.get(f"/{force}/{neighbourhood_id}/boundary")
    ...
    async def get_people(
        ...
        """
        response = await self.get(f"/{force_id}/{neighbourhood_id}/people")
...
class NeighbourhoodAPI(BaseSyncAPI):
    """Neighbourhood-related syncronous API methods for the UK Police API."""
    ...
    def get_all_neighbourhoods(
        ...
        Returns:
            A list of all neighbourhoods for a force (basic summary only).
        """
        response = self.get(f"/{force}/neighbourhoods")
        neighbourhoods_data = response.json()
    ...
    def get_neighbourhood(
        ...
        Returns:
            A specific neighbourhood.
        """
        response = self.get(f"/{force}/{neighbourhood_id}")
        neighbourhood_data = response.json()
    ...
    def get_boundary(self, force: str, neighbourhood_id: str) -> Neighbourhood:
        """Returns the boundary of a specific neighbourhood by ID.
        ...
        Returns:
            A specific neighbourhood boundary in GeoJSON & Shapely format.
        """
        response = self.get(f"/{force}/{neighbourhood_id}/boundary")
        boundary_data = response.json()
    ...
    def get_people(
        ...
        Returns:
            A list of people (officers) in a specific neighbourhood.
        """
        response = self.get(f"/{force_id}/{neighbourhood_id}/people")
        people_data = response.json()
